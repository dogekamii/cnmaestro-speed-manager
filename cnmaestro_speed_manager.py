...
class App(tk.Tk):
 ...
 def toggle_mosaic_candidate(self,key):
  ...
  if not candidate or not candidate.get('eligible') or candidate.get('state')=='unknown':return
